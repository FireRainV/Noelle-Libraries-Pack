...
function character:init()
    ...
    self:setActor("party/berdly")
    self:setLightActor("party/berdly_lw")
    ...
    self.color = { 94 / 255, 188 / 255, 255 / 255 }
    -- Damage color (for the number when attacking enemies) (defaults to the main color)
    self.dmg_color = { 110 / 255, 210 / 255, 255 / 255 }
    -- Attack bar color (for the target bar used in attack mode) (defaults to the main color)
    self.attack_bar_color = { 105 / 255, 200 / 255, 240 / 255 }
    -- Attack box color (for the attack area in attack mode) (defaults to darkened main color)
    self.attack_box_color = { 60 / 255, 140 / 255, 200 / 255 }
    -- X-Action color (for the color of X-Action menu items) (defaults to the main color)
    self.xact_color = { 110 / 255, 210 / 255, 255 / 255 }
...
function character:getGameOverMessage(main)
    return {
        "Oh, no! ".. main:getName() ..",\n[wait:5]are you all right?",
        "Do not die on me\n".. main:getName() .."![wait:5] Do not!!!"
    }
end
