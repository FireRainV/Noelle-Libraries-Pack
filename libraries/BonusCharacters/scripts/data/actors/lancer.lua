local actor, super = Class(Actor, "party/lancer")
...
function actor:init()
    ...
    self.hitbox = { 2, 17, 26, 12 }

    -- A table that defines where the Soul should be placed on this actor if they are a player.
    -- First value is x, second value is y.
    self.soul_offset = { 14, 18 }
    ...
    self.animations = {
        ...
        ["laugh_left"]          = { "laugh_left", 0.1, true },
        ["laugh_right"]         = { "laugh_right", 0.1, true },
        ["laughmustache_left"]  = { "laughmustache_left", 0.1, true },
        ["laughmustache_right"] = { "laughmustache_right", 0.1, true },
