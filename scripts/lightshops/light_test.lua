...
function TestShop:init()
    ...
    self.sell_no_storage_encounter_text = "* Nothing in there."
    ...
    self:registerItem("undertale/legendary_hero", { free = true })
...
function TestShop:startTalk(talk)
    if talk == "Reflect" then
        self:startDialogue({
            ...
            "* Which is a little odd.[wait:5] Because I can't find the way out either.",
            ...
            "* I don't know.",
            "* If I knew,[wait:5] I wouldn't have said that I don't know just now.",
